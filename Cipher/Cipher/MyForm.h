...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Vigenere->Location = System::Drawing::Point(382, 285);
			...
			// KeyWord
			// 
			this->KeyWord->Location = System::Drawing::Point(363, 307);
			...
			this->label1->Location = System::Drawing::Point(265, 309);
			...
			this->label3->Location = System::Drawing::Point(45, 147);
			...
			this->Caesar->Location = System::Drawing::Point(48, 285);
			...
			this->label4->Location = System::Drawing::Point(15, 309);
			...
			this->Direction->Location = System::Drawing::Point(114, 307);
			...
			// Encrypt
			// 
			this->Encrypt->Location = System::Drawing::Point(181, 339);
			...
			// Shift
			// 
			this->Shift->Location = System::Drawing::Point(61, 307);
			...
			// Output
			// 
			this->Output->Location = System::Drawing::Point(48, 163);
			...
			// Input
			// 
			this->Input->Location = System::Drawing::Point(48, 22);
			...
			this->label5->Location = System::Drawing::Point(398, 370);
			this->label5->Name = L"label5";
			this->label5->Size = System::Drawing::Size(129, 13);
			this->label5->TabIndex = 15;
			this->label5->Text = L"бесполезный лейбл кек";
			// 
			// MyForm
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(6, 13);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(539, 395);
